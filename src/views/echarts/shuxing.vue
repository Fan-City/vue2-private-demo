<template>
  <div class="shuxingPage">
    <div id="shuxing" class="shuxingEcharts"></div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    initEchart() {
      let shuxingEcharts = echarts.init(document.getElementById("shuxing"));
      let src1 =
    ...
    <div>
      ...
      shuxingEcharts.setOption(option);
    },
  },
};
</script>
