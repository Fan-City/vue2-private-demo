...
var DiffCompare = (function () {
   ...
   * @author WZS
   */
  DiffCompare.prototype.diff = function (text1, text2, line_based) {
    // 开始时间
   ...
   * @author WZS
   */
  DiffCompare.prototype.init = function (text1, text2) {
    this.text1 = text1;
    this.text2 = text2;
   ...
   * @author WZS
   */
  DiffCompare.prototype.getLCS = function () {
    var lcs = '';
    var path = this.path;
    var text = this.text1;
   ...
   * @author WZS
   */
  DiffCompare.prototype.getDiffsFromPath = function () {
    var diffs = [];
   ...
   * @author WZS
   */
  DiffCompare.prototype.mergeDiffs = function (df) {
    if (!df || !df.length) {
      return [];
    }
    var diffs = [];
   ...
   * @author WZS
   */
  DiffCompare.prototype.prettyHtml = function () {
    ...
    for (var x = 0; x < diffs.length; x++) {
      ...
      switch (op) {
        case DIFF_INSERT:
          html[x] = '<ins style="background:#8cff8c !important;">' + text + '</ins>';
          break;
        case DIFF_DELETE:
          html[x] = '<del style="background:#ffc3c3 !important;">' + text + '</del>';
          break;
        case DIFF_EQUAL:
          html[x] = text;
          break;
